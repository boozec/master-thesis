...
\end{tikzpicture}
\caption{Merkle tree constructed from the root hashes of top-level folders. Each folder root acts as a leaf in this Merkle tree. Internal nodes are omitted for clarity.}
...
\end{tikzpicture}
\caption{Merkle tree constructed from the root hashes of second-level folders. Each folder root acts as a leaf in this Merkle tree. Internal nodes are omitted for clarity.}
